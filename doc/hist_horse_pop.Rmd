...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
kable(max_horses, caption = "Table 1. Range of the number horses for each provinces at any time point between 1940 - 1972")
```
...
Figure 2. The number of horse for `r params$province` between 1940 - 1972.
